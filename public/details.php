	...
	<div class="container basic-info">
		<div class="col-xs-12 col-md-6 img-preview">
			...
			<div class="gallery">
				...
				<div class="img-container middle active">
	...
	<div class="col-xs-12 tabs">
		<ul class="nav nav-tabs">
			<div class="container">
				...
				<li><div class="active-border"><a>Shipping</a></div></li>
				<li><div class="active-border"><a>Sizing</a></div></li>
			</div>
		</ul>
		<div class="container">
			<div class="tabs-text description">
